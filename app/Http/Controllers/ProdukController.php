    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('stock', function ($produk) {
                return angka($produk->stock);
            })
            ->addColumn('aksi', function ($produk) {
                return '
                <div class="btn-group" style="display: flex; justify-content: center;">
                    <button type="button" onclick="editForm(`' . route('produk.update', $produk->id_produk) . '`)" class="btn btn-sm btn-info"><i class="fa fa-pencil"></i> Edit</button>
