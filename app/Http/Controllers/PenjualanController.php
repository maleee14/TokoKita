...
class PenjualanController extends Controller
{
    ...
    public function data()
    {
        ...
        return datatables()
            ...
            ->addColumn('kode_member', function ($penjualan) {
                $member = $penjualan->member->kode_member ??  ''; //Mengatasi error Trying to access array offset on value of type null
                return '<span class="label label-success">' . $member . '</span>';
            })
            ->addColumn('total_item', function ($penjualan) {
                return angka($penjualan->total_item);
            })
            ...
            ->addColumn('aksi', function ($penjualan) {
                ...
                <div class="btn-group" style="display: flex; justify-content: center;">
                    <button onclick="showDetail(`' . route('penjualan.show', $penjualan->id_penjualan) . '`)" class="btn btn-sm btn-info"><i class="fa fa-eye"> Detail</i></button>
                    <button onclick="deleteData(`' . route('penjualan.destroy', $penjualan->id_penjualan) . '`)" class="btn btn-sm btn-danger"><i class="fa fa-trash"> Hapus</i></button>
                </div>
                ';
            })
    ...
    public function notaBesar()
    {
        ...
        return $pdf->stream('Transaksi-' . date('Y-m-d-his') . '.pfd');
    }
}
